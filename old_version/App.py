...
def update_vtuber_graphs(vtuber):
    ...
    fig_publi_trend = px.histogram(df_video, x='publication_weekday', category_orders=dict(day=['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday']))
    ...
    fig_videogames = go.Figure(data=[go.Pie(labels=labels, values=values, hole=.3)])
